...
const pusher = new Pusher("995671abf7943b494423", { cluster: "eu" });
const BACKEND_ADDRESS = process.env.EXPO_PUBLIC_ADDRESS_IP;
...
export default function ChatScreen({ navigation, route: { params } }) {
    ...
    useEffect(() => {
        ...
        return async () => {
            await fetch(`${BACKEND_ADDRESS}/users/${params.username}`, { method: "DELETE" });
    ...
    async function stopRecording() {
        ...
        formData.append("audioFromFront", {
            uri,
            name: "audio.mp3",
            type: "audio/mp3",
        });

        fetch(`${BACKEND_ADDRESS}/audio`, {
            method: "POST",
            body: formData,
        })
                ...
                <ScrollView style={styles.scroller}>
                    {messages.map((message, i) => (
                        ...
                        >
                            ...
                            >
                                {message.url ? (
                                    <TouchableOpacity onPress={() => onPlaySound(message.url)}>
                                        <FontAwesome
                                            name="file-audio-o"
                                            size={30}
                                            color="#000000"
